    ...
    <div class="wrap">
        ...
        <table class="form-table">
            <tr valign="top">
                ...
                <td><input name="<?= $plugin->getOptionName('wwk_shop_id');?>" type="text" id="wwk-shop-id" value="<?= esc_html($config['wwk_shop_id']); ?>" class="regular-text" /></td>
            </tr>
            <tr valign="top">
            ...
            <tr valign="top">
                ...
                <td><input name="<?= $plugin->getOptionName('invite_delay');?>" type="text" id="webwinkelkeur-invite-delay" value="<?= esc_html($config['invite_delay']); ?>" class="small-text" />
                <p class="description">
